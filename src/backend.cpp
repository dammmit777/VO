...
void Backend::Optimize(Map::KeyframesType &keyframes, Map::LandmarksType &landmarks)
{
    ...
    for (auto &keyframe : keyframes)
    {
        ...
        VertexPose *vertex_pose = new VertexPose(); //相机顶点位姿
    ...
    std::map<EdgeProjection *, Feature::Ptr> edge_and_features;
    ...
    for (auto &landmark : landmarks)
    {
        ...
        for (auto &obs : observations)
        {
            ...
            edge_and_features.insert({edge, feat});
